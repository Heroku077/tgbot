...
It took lots of work for [my creator](t.me/mr_anshu_07) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; Join [GROUP](t.me/sol_allupdates), or [CHANNEL](t.me/sol_allupdate)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Hello", url="https://t.me/spiderman07_bot")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/sol_allupdates"), InlineKeyboardButton(text="🔔 Updates", url="https://t.me/mr_anshu_07")],
                     [InlineKeyboardButton(text="😎 Supported Channel", url="https://t.me/sol_allupdate"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))

    else:
        update.effective_message.reply_text("Loading...")
